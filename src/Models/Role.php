...
use OmniGuard\Exceptions\RoleAlreadyExists;
...
class Role extends Model implements RoleContract
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->table = config('omniguard.table_names.roles', 'omni_roles');
    }
    ...
    public function users(): BelongsToMany
    {
        return $this->morphedByMany(
            ...
            'model',
            config('omniguard.table_names.model_has_roles'),
     ...
     */
    public function hasHigherRankThan(RoleContract $role): bool
    {
        return $this->sort_order < $role->sort_order;
    }
}
