...
class PermissionRegistrar
{
    ...
    {
        $this->cacheExpirationTime = config('omniguard.cache.expiration_time') ?: \DateInterval::createFromDateString('24 hours');

        $this->teams = config('omniguard.teams', false);
        $this->teamsKey = config('omniguard.column_names.team_foreign_key', 'team_id');
