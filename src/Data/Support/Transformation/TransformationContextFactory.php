...
class TransformationContextFactory
{
    ...
    protected function __construct(
        ...
        $this->maxDepth = config('omniguard.data.max_transformation_depth', null);
        $this->throwWhenMaxDepthReached = config('omniguard.data.throw_when_max_transformation_depth_reached', true);
    }
