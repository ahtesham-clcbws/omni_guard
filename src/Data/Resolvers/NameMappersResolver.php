...
class NameMappersResolver
{
    ...
    protected function resolveInputNameMapper(
        ...
        return $this->resolveDefaultNameMapper(config('omniguard.data.name_mapping_strategy.input'));
    }
    ...
    protected function resolveOutputNameMapper(
        ...
        return $this->resolveDefaultNameMapper(config('omniguard.data.name_mapping_strategy.output'));
    }
